...
const Navbar = () => {
  ...
  return (
    // <div className="navbar text-white shadow-sm  bg-black px-3  opacity-75 fixed top-0 ">
    ...
    <div className="navbar bg-base-100 shadow-sm bg-black px-2  z-10 sticky top-0">
      <div className="navbar-start">
        <div className="dropdown">
          <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
